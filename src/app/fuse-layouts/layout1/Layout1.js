					...
					{({ routes }) => (
						...
						>
							...
							<div className="flex flex-1 flex-col overflow-hidden relative">
								...
								layoutConfig.toolbar.position === 'above' && <ToolbarLayout1 />}
								...
								<FuseScrollbars className="overflow-auto">
									...
									<div className={classes.wrapper}>
										...
										layoutConfig.navbar.position === 'left' && <NavbarWrapperLayout1 />}

										<div className={classes.contentWrapper}>
											{layoutConfig.toolbar.display &&
											layoutConfig.toolbar.position === 'below' && <ToolbarLayout1 />}
										...
										{layoutConfig.navbar.display &&
										layoutConfig.navbar.position === 'right' && <NavbarWrapperLayout1 />}
									</div>
							...
							<div className="flex flex-1 flex-col overflow-hidden relative">
								...
								<div className={classes.wrapper}>
									...
									<div className={classes.contentWrapper}>
										...
										layoutConfig.toolbar.style === 'fixed' && <ToolbarLayout1 />}
